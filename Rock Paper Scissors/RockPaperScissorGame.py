...
# Define images
Blank_img = PhotoImage(file="assets/blank.png")
Player_Rock = PhotoImage(file="assets/rock_player.png")
Player_Rock_ado = Player_Rock.subsample(3, 3)
Player_Paper = PhotoImage(file="assets/paper_player.png")
Player_Paper_ado = Player_Paper.subsample(3, 3)
Player_Scissor = PhotoImage(file="assets/scissor_player.png")
Player_Scissor_ado = Player_Scissor.subsample(3, 3)
Computer_Rock = PhotoImage(file="assets/rock_computer.png")
Computer_Paper = PhotoImage(file="assets/paper_computer.png")
Computer_Scissor = PhotoImage(file="assets/scissor_computer.png")
